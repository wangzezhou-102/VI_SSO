package com.secusoft.web.core.intercept;
...
@Aspect
@Component
@ConditionalOnProperty(prefix = "config", name = "session-open", havingValue = "true")
public class SessionTimeoutInterceptor extends BaseController {

    @Pointcut("execution(* com.secusoft.web.*..controller.*.*(..))")
