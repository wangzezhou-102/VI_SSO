...
import com.secusoft.web.common.constant.dictmap.factory.DictFieldWarpperFactory;
...
public class Contrast {
     ...
     * @Date 2017/5/9 19:34
     */
    public static String contrastObj(Class<? extends AbstractDictMap> dictClass, String key, Object pojo1, Map<String, String> pojo2) throws IllegalAccessException, InstantiationException {
     ...
     * @Date 2017/5/9 19:34
     */
    public static String contrastObjByName(Class<? extends AbstractDictMap> dictClass, String key, Object pojo1, Map<String, String> pojo2) throws IllegalAccessException, InstantiationException {
        AbstractDictMap dictMap = (AbstractDictMap) dictClass.newInstance();
        String str = parseMutiKey(dictMap, key, pojo2) + separator;
        try {
            Field[] fields = pojo1.getClass().getDeclaredFields();
            ...
            for (Field field : fields) {
                ...
                try {
                    getMethod = pojo1.getClass().getDeclaredMethod(prefix + StrKit.firstCharToUpperCase(field.getName()));
                } catch (NoSuchMethodException e) {
                    System.err.println("this className:" + pojo1.getClass().getName() + " is not methodName: " + e.getMessage());
                    continue;
                }
                Object o1 = getMethod.invoke(pojo1);
