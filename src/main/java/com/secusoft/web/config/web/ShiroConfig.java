...
import com.secusoft.web.core.shiro.ShiroDbRealm;
...
public class ShiroConfig {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "conifg", name = "spring-session-open", havingValue = "true")
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "conifg", name = "spring-session-open", havingValue = "false")
