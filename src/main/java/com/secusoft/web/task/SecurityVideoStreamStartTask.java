...
//                    log.info("时间不一致，无法启流，布控任务编号：" + securityTaskRequest.getTaskId());
//                    return;
//                }
//            }
//
//            ViSurveyTaskBean viSurveyTask = viTaskDeviceMapper.getViTaskDeviceByObject(viTaskDeviceMapper);
...
//                            log.info("设备号：" + viTaskDeviceBean.getDeviceId() + "，启流成功，布控任务编号：" + securityTaskRequest.getTaskId());
...
//        }
        ...
        log.info("结束停流，布控任务编号：" + securityTaskRequest.getTaskId());
    }
}
