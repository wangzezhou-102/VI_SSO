...
public class PatrolAlarmBean {
    ...
    private List<PatrolAlarmBean> viPsurveyAlarmBeans;
    ...
    public List<PatrolAlarmBean> getViPsurveyAlarmBeans() {
        return viPsurveyAlarmBeans;
    }

    public void setViPsurveyAlarmBeans(List<PatrolAlarmBean> viPsurveyAlarmBeans) { this.viPsurveyAlarmBeans = viPsurveyAlarmBeans; }
}