...
public class SemanticSearchClient {
    ...
    private static Logger log = LoggerFactory.getLogger(SemanticSearchClient.class);

    public static String tuSouEndpoint = NormalConfig.getAddrApiSemanticSearch();
     ...
     * @return
     */
    public static SemanticSearchClient getClientConnectionPool() {
        if (HttpClientConnectionPool == null) {
            synchronized (SemanticSearchClient.class) {
                if (HttpClientConnectionPool == null) {
                    HttpClientConnectionPool = new SemanticSearchClient();
                }
            }
        }
