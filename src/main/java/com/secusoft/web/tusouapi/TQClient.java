...
public class TQClient {
    ...
    private static Logger log = LoggerFactory.getLogger(TQClient.class);

    public static String tuSouEndpoint = NormalConfig.getAddrApiBk();
    ...
    private volatile static TQClient HttpClientConnectionPool;
     ...
     * @return
     */
    public static TQClient getClientConnectionPool() {
        if (HttpClientConnectionPool == null) {
            synchronized (TQClient.class) {
                if (HttpClientConnectionPool == null) {
                    HttpClientConnectionPool = new TQClient();
                }
            }
        }
