 ...
 */
(function () {
    var BSTable = function (bstableId, url, columns, events) {
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    searchOnEnterKey: false, //设置为true，回车搜索，否则自动搜索
                    ...
                    responseHandler: this.responseHandler,  //处理服务器返回的数据
